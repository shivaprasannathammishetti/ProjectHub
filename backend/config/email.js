...
const sendVerificationEmail = async (email, name, token) => {
  const verifyUrl = `https://projecthub-frontend-iota.vercel.app/verify.html?token=${token}`;
      ...
      <div style="font-family: Inter, sans-serif; max-width: 500px; margin: 0 auto; background: #0f172a; color: #e2e8f0; border-radius: 16px; overflow: hidden;">
        ...
        <div style="padding: 32px;">
          ...
          <p style="color: #94a3b8; line-height: 1.6; margin-bottom: 28px;">
            ...
            You've been added as a member and can now view tasks, track progress, and work together in real time!
          </p>
          ...
          <div style="text-align: center; margin-bottom: 24px;">
            <a href="https://projecthub-frontend-iota.vercel.app" style="
              display: inline-block;
